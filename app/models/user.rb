class User < ApplicationRecord
  ...
  USER_PARAMS = %i(name email phone_number address password password_confirmation).freeze
  ...
  validates :phone_number, presence: true, numericality: { only_integer: true }, length: {maximum: Settings.user.phone_number}
